...
class AEOCAS_Audit_Api {
    ...
    public static function preview_rewrite( $page_url ) {
        ...
        if ( is_wp_error( $response ) ) {
            AEOCAS_Activity_Log::log( 'rewrite_preview', 'error', array( 'message' => $response->get_error_message(), 'page_url' => $page_url ), $post_id );
            return new WP_Error( 'aeocas_api_error', $response->get_error_message() );
        }
        ...
        if ( $status >= 400 ) {
            ...
            AEOCAS_Activity_Log::log( 'rewrite_preview', 'error', array( 'message' => $message, 'page_url' => $page_url ), $post_id );
        ...
        AEOCAS_Activity_Log::log( 'rewrite_preview', 'success', array( 'message' => 'Rewrite preview generated.', 'page_url' => $page_url ), $post_id );
    ...
    public static function create_rewrite_draft( $payload ) {
        ...
        if ( is_wp_error( $result ) ) {
            AEOCAS_Activity_Log::log( 'rewrite_draft', 'error', array( 'message' => $result->get_error_message(), 'page_url' => $page_url ), $source_post_id );
            return $result;
        }
        ...
        AEOCAS_Activity_Log::log( 'rewrite_draft', 'success', array( 'message' => 'Rewrite draft created.', 'page_url' => $page_url ), $source_post_id );
    ...
    public static function ajax_get_rewrite_availability() {
        ...
        if ( is_wp_error( $availability ) ) {
            wp_send_json_error( array( 'message' => $availability->get_error_message(), 'code' => $availability->get_error_code() ) );
        }
    ...
    public static function ajax_get_rewrite_checkout_url() {
        ...
        if ( is_wp_error( $checkout ) ) {
            wp_send_json_error( array( 'message' => $checkout->get_error_message(), 'code' => $checkout->get_error_code() ) );
        }
    ...
    public static function ajax_preview_rewrite() {
        ...
        if ( is_wp_error( $preview ) ) {
            wp_send_json_error( array( 'message' => $preview->get_error_message(), 'code' => $preview->get_error_code() ) );
        }
